...
How does RBI monetary policy transmit to inflation outcomes in India — and how does the central bank set interest rates in response to inflationary pressure?

This project examines two related questions empirically:

| Question | Economic Framework | Method |
|---|---|---|
| Does a past repo rate hike reduce future inflation? | **Monetary Transmission** | SQL |
| How does RBI adjust rates in response to past inflation? | **Policy Reaction Function** | Python |
...
> Key observation:  No same-period relationship between inflation and repo rate | R² = 0.000, contemporaneous correlation ≈ 0. | Repo rate is less volatile than inflation (std 1.14 vs 1.69), consistent with **interest rate smoothing** — central banks avoid abrupt policy changes. |Monetary policy transmission peaks at 9 months | SQL lag correlations strengthen from −0.19 (3m) to −0.37 (9m) |
| Lagged model explains 98.3% of repo variation | R² jumps from 0.000 to 0.983 when lag is introduced |
| 2020 is a structural break | Repo cut to 4% despite elevated inflation — COVID growth priority|
...
## Phase 2 — SQL Analysis (Monetary Transmission)
...
This is a **Partial Adjustment / Interest Rate Smoothing Model** 
```python
